                  ...
                  <form class="form-inline my-2 my-lg-0">
                     ...
                     <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="user_icon"><i class="fa fa-user" aria-hidden="true"></i></span> My Profile
                            </a>
                        <div class="dropdown-menu" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="profile.php"><i class="fas fa-user-circle"></i> View Profile</a>
                            <a class="dropdown-item" href="index.php"><i class="fas fa-user-circle"></i> Log Out</a>
